...
<div style="height:50px;background-color:black;color:white;font-size:15px;font-weight:bold;">
    <p style="color:white; padding:20px; text-decoration:none"><a style="color:white;" href="addtrack.php">Edit/Delete User</a></p>
    </div>
    <div id="div1">
   <div class="container">
   <div id="">
...
if(isset($_POST['button'])){    //trigger button click
  ...
  $result=mysqli_query($con,"select * from users where username like '%{$search}%' || password like '%{$search}%' || email like  '%{$search}%' ||type like '%{$search}%' ");
...
$result=mysqli_query($db,"SELECT * FROM users ORDER BY $order $sort");
...
if(mysqli_num_rows($result)>0){
  ...
  echo"
    ...
    <tr><th><a href='?order= username && sort=$sort'>Username</a></td>
    <th>Password</td>
    <th>Email</td>
    <th><a href='?order= type && sort=$sort'>Type</a></td></tr>
