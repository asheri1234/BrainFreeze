      ...
      <div class="container">
        <div id="nav-side">
              ...
              <div class="button">
               ...
               <a href="report.php" class="btn btn-one">Request report</a>
               <a href="verify.php" class="btn btn-two">Request withdrawal</a>
               <a href="confirm.php" class="btn btn-two">Enter confirmation code</a>
